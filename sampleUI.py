...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lemmaBtn = CustomButton("assets/open-book.png", "Lemmatization", "\nGet dictionary form of each words", self.featurePage)
        self.lemmaBtn.setObjectName("lemmaBtn")
        self.horizontalLayout_4.addWidget(self.lemmaBtn)
        self.validationBtn = CustomButton("assets/stamp.png", "Validation", "\nView valid tokens for lemmatization", self.featurePage)
        ...
        self.comboBoxLabel = QtWidgets.QLabel(parent=self.lemmaPage)
