...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lemmaBtn = CustomButton("assets/open-book.png", "Lemmatization", "Get dictionary form of each words", self.featurePage)
        self.lemmaBtn.setObjectName("lemmaBtn")
        self.horizontalLayout_4.addWidget(self.lemmaBtn)
        self.validationBtn = CustomButton("assets/stamp.png", "Validation", "View valid tokens for lemmatization", self.featurePage)
        self.validationBtn.setObjectName("validationBtn")
        self.horizontalLayout_4.addWidget(self.validationBtn)
        self.processBtn = CustomButton("assets/engineering.png", "Process", "See the process behind the scene", self.featurePage)
        self.processBtn.setObjectName("processBtn")
        self.horizontalLayout_4.addWidget(self.processBtn)
        self.annotationBtn = CustomButton("assets/note.png", "Annotation", "Key value pair of lemma", self.featurePage)
